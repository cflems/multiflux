...
'Choose forum language'		=>	'Choose your forum language',
'Choose forum language info'	=>	'The default language used to render text on your forum. This will be used by guests and users who have not selected a different language.',
'Forum language'		  		=>	'Forum language',
'Change language'				=>	'Change language',
'Already installed'				=>	'It seems like MultiFlux is already installed. You should go <a href="setup.php">here</a> instead.',
...
'FluxBB Installation'			=>	'MultiFlux Installation',
'FluxBB Setup'          =>  'FluxBB Setup',
'Welcome'						=>	'You are about to install MultiFlux. In order to install MultiFlux, you must complete the form set out below. If you encounter any difficulties with the installation, please refer to the documentation.',
'Welcome Setup'					=>	'You are about to set up FluxBB. In order to configure your FluxBB forum, you must complete the form set out below.',
'Install'						=>	'Install MultiFlux %s',
'Set Up'            =>  'Configure FluxBB %s',
...
'Info 4'						=>	'The name of the database you want to install MultiFlux into.',
...
'Info 6'						=>	'If you want to prevent overlapping common table names, such as users, bans, posts, etc., change this.',
...
'Existing table error'			=>	'A table called \'%susers\' is already present in the database \'%s\'. This could mean that MultiFlux or FluxBB is already installed or that another piece of software is installed and is occupying one or more of the table names MultiFlux requires',
...
'FluxBB has been installed'		=>	'MultiFlux has been installed. To finalize the installation please follow the instructions below.',
'FluxBB has been set up'	   	=>	'Your FluxBB forum has been set up. To finalize the configuration please follow the instructions below.',
'Final instructions'			=>	'Final instructions',
'Info 17'						=>	'To finalize the installation, you need to click on the button below to download a file called config.php. You then need to upload this file to the root directory of your MultiFlux installation.',
'Info 18'						=>	'Once you have uploaded config.php, MultiFlux will be fully installed! At that point, you may <a href="setup.php">set up your first forum</a>.',
'Download config.php file'		=>	'Download config.php file',
'FluxBB fully installed'		=>	'MultiFlux has been installed. The next step is to <a href="setup.php">set up your first forum</a>.',
'FluxBB successfully set up'  =>  'FluxBB has been successfully set up! You may now <a href="index.php">go to the forum index</a>.',
'Host mismatch error'         =>  'The forum you are trying to configure is not the one you are accessing the installer from. Please correct this discrepancy',
'Already configured error'    =>  'This forum has already been configured. Please return to the forum index',
